...
The database variable can be named `DATABASE_URL`, `POSTGRES_URL`, `POSTGRESQL_URL`, `DATABASE_PUBLIC_URL`, `DATABASE_INTERNAL_URL`, `RENDER_DATABASE_URL`, or `ConnectionStrings__DefaultConnection`.
